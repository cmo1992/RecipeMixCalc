/**
 * This class adds Recipes to the database. It Links the Company and Recipe name
 * to a generated Recipe ID number. Then it adds the Ingredients and Recipe ID
 * with the percentage on that ingredient in the mix to another table.
 * @author cmo
 */
/**
...
public class FrmRecipe extends javax.swing.JFrame {
     ...
     * @Detail: This method inserts the selected ingredient and percentage to 
     * the current recipe
     * @param evt 
     */
    ...
    * @Detail: This takes the user back to the main menu.
    * @param evt 
    */
   ...
   /**
    * @Method: formWindowActivated
    * @Detail: This removes all contents of the company and ingredient combo 
    * boxes and gets all the companies and ingredients from the database and
    * put them in there combo box.
    * @param evt 
    */
   ...
   /**
    * @Method: btnAddrecipeNameActionPerformed
    * @Detail: this method adds the company and recipe to the table and gets the
    * recipes ID for when adding the ingredients.
    * @param evt 
    */
...
/**
    ...
    /**
     * @Method: loadtable
     * @Detail: This method updates the table with all the ingredients that
